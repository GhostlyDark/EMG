...
preferences = {contextIsolation:false,preload:path.join(app.getAppPath(), 'preload.js')},
...
Menu.setApplicationMenu(Menu.buildFromTemplate([
	...
	{label: menuFunctions, submenu: [
	  ...
	  {icon: nativeImage.createFromPath(path.join(dir, 'img', 'save.png')).resize(scale), label: menuSaves, click () {shell.openPath(path.join(app.getPath('appData'), 'mupen64plus'))}},
	  {type: 'separator'},
