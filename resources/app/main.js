...
ipcMain.on('resetZoom', () => {win.webContents.setZoomFactor(1.0)})
ipcMain.on('decreaseZoom', () => {if(win.webContents.getZoomFactor().toFixed(1) != 0.1)win.webContents.setZoomFactor(win.webContents.getZoomFactor()-0.1)})
ipcMain.on('increaseZoom', () => {if(win.webContents.getZoomFactor().toFixed(1) != 5.0)win.webContents.setZoomFactor(win.webContents.getZoomFactor()+0.1)})
ipcMain.on('devTools', () => {win.webContents.toggleDevTools()})
ipcMain.on('appReload', () => {win.reload()})
