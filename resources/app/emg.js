...
numbers = ['OverscanNtscTop','OverscanNtscLeft','OverscanNtscRight','OverscanNtscBottom','OverscanPalTop','OverscanPalLeft','OverscanPalRight','OverscanPalBottom','NumWorkers','ParallelCropOverscan','txCacheSize','txHiresVramLimit','GammaCorrectionLevel','fontSize','CountPerOp','CountPerOpDenomPot','CurrentStateSlot','VOLUME_ADJUST','VOLUME_DEFAULT','PolygonOffsetFactor','PolygonOffsetUnits','polygon_offset_factor','polygon_offset_units','ghq_cache_size'],
...
if(number_input.step==='128'){step=128}
else if(number_input.step==='512'){step=512}
else if(number_input.step==='0.1'){step=0.1;digits=2}
...
number_input.value = (parseFloat(number_input.value) - step).toFixed(digits)
...
if(localStorage.getItem('IPLROM') === null || localStorage.getItem('IPLROM') === undefined){IPLROM = '';id('IPLROMText').innerHTML = IPLROM}
...
if(localStorage.getItem('Disk') === null || localStorage.getItem('Disk') === undefined){Disk = '';id('DiskText').innerHTML = Disk}
...
if(localStorage.getItem('gbROM1') === null || localStorage.getItem('gbROM1') === undefined){gbROM1 = '';id('gbROM1Text').innerHTML = gbROM1}
...
if(localStorage.getItem('gbROM2') === null || localStorage.getItem('gbROM2') === undefined){gbROM2 = '';id('gbROM2Text').innerHTML = gbROM2}
...
if(localStorage.getItem('gbROM3') === null || localStorage.getItem('gbROM3') === undefined){gbROM3 = '';id('gbROM3Text').innerHTML = gbROM3}
...
if(localStorage.getItem('gbROM4') === null || localStorage.getItem('gbROM4') === undefined){gbROM4 = '';id('gbROM4Text').innerHTML = gbROM4}
...
if(localStorage.getItem('gbRAM1') === null || localStorage.getItem('gbRAM1') === undefined){gbRAM1 = '';id('gbRAM1Text').innerHTML = gbRAM1}
...
if(localStorage.getItem('gbRAM2') === null || localStorage.getItem('gbRAM2') === undefined){gbRAM2 = '';id('gbRAM2Text').innerHTML = gbRAM2}
...
if(localStorage.getItem('gbRAM3') === null || localStorage.getItem('gbRAM3') === undefined){gbRAM3 = '';id('gbRAM3Text').innerHTML = gbRAM3}
...
if(localStorage.getItem('gbRAM4') === null || localStorage.getItem('gbRAM4') === undefined){gbRAM4 = '';id('gbRAM4Text').innerHTML = gbRAM4}
...
if(localStorage.getItem('ScreenshotPath') === null || localStorage.getItem('ScreenshotPath') === undefined){ScreenshotPath = '';id('ScreenshotPathText').innerHTML = ScreenshotPath}
...
if(localStorage.getItem('SaveStatePath') === null || localStorage.getItem('SaveStatePath') === undefined){SaveStatePath = '';id('SaveStatePathText').innerHTML = SaveStatePath}
...
if(localStorage.getItem('SaveSRAMPath') === null || localStorage.getItem('SaveSRAMPath') === undefined){SaveSRAMPath = '';id('SaveSRAMPathText').innerHTML = SaveSRAMPath}
...
if(localStorage.getItem('txPath') === null || localStorage.getItem('txPath') === undefined){txPath = hires_texture;id('txPathText').innerHTML = txPath}
...
if(localStorage.getItem('txCachePath') === null || localStorage.getItem('txCachePath') === undefined){txCachePath = cache;id('txCachePathText').innerHTML = txCachePath}
...
if(localStorage.getItem('txDumpPath') === null || localStorage.getItem('txDumpPath') === undefined){txDumpPath = texture_dump;id('txDumpPathText').innerHTML = txDumpPath}
...
if(id('mouse1').checked === false){id('mouse1_1').disabled = true;id('mouse1_2').disabled = true;id('mouse1_3').disabled = true;id('MouseSensitivity1X').disabled = true;id('MouseSensitivity1Y').disabled = true}
...
if(id('mouse2').checked === false){id('mouse2_1').disabled = true;id('mouse2_2').disabled = true;id('mouse2_3').disabled = true;id('MouseSensitivity2X').disabled = true;id('MouseSensitivity2Y').disabled = true}
...
if(id('mouse3').checked === false){id('mouse3_1').disabled = true;id('mouse3_2').disabled = true;id('mouse3_3').disabled = true;id('MouseSensitivity3X').disabled = true;id('MouseSensitivity3Y').disabled = true}
...
if(id('mouse4').checked === false){id('mouse4_1').disabled = true;id('mouse4_2').disabled = true;id('mouse4_3').disabled = true;id('MouseSensitivity4X').disabled = true;id('MouseSensitivity4Y').disabled = true}
...
filePath = fPath;id('IPLROMText').innerHTML = fPath;localStorage.setItem('IPLROM', fPath)}}}
...
filePath = fPath;id('DiskText').innerHTML = fPath;localStorage.setItem('Disk', fPath)}}}
...
filePath = fPath;id('gbROM1Text').innerHTML = fPath;localStorage.setItem('gbROM1', fPath)}}}
...
if(fPath != undefined){
if(fileExtension(fPath) === 'gb' || fileExtension(fPath) === 'gbc'){
filePath = fPath;id('gbROM2Text').innerHTML = fPath;localStorage.setItem('gbROM2', fPath)}}}
...
if(fPath != undefined){
if(fileExtension(fPath) === 'gb' || fileExtension(fPath) === 'gbc'){
filePath = fPath;id('gbROM3Text').innerHTML = fPath;localStorage.setItem('gbROM3', fPath)}}}
...
if(fPath != undefined){
if(fileExtension(fPath) === 'gb' || fileExtension(fPath) === 'gbc'){
filePath = fPath;id('gbROM4Text').innerHTML = fPath;localStorage.setItem('gbROM4', fPath)}}}
...
filePath = fPath;id('gbRAM1Text').innerHTML = fPath;localStorage.setItem('gbRAM1', fPath)}}}
...
if(fPath != undefined){
if(fileExtension(fPath) === 'sav'){
filePath = fPath;id('gbRAM2Text').innerHTML = fPath;localStorage.setItem('gbRAM2', fPath)}}}
...
if(fPath != undefined){
if(fileExtension(fPath) === 'sav'){
filePath = fPath;id('gbRAM3Text').innerHTML = fPath;localStorage.setItem('gbRAM3', fPath)}}}
...
if(fPath != undefined){
if(fileExtension(fPath) === 'sav'){
filePath = fPath;id('gbRAM4Text').innerHTML = fPath;localStorage.setItem('gbRAM4', fPath)}}}
...
if(id('exp').checked === true){exp = 'Core[DisableExtraMem]=True'}else{exp = 'Core[DisableExtraMem]=False'}
if(id('osd').checked === true){osd = '--osd'}else{osd = '--noosd'}
if(id('fullScreen').checked === true){fullscreen = '--fullscreen';ParallelFullscreen = 'Video-Parallel[Fullscreen]=True'}else{fullscreen = '--windowed';ParallelFullscreen = 'Video-Parallel[Fullscreen]=False'}
if(id('vsync').checked === true){vsync = 'Video-General[VerticalSync]=True';Glide64VSync = 'Video-Glide64mk2[vsync]=True'}else{vsync = 'Video-General[VerticalSync]=False';Glide64VSync = 'Video-Glide64mk2[vsync]=False'}
if(id('rspGFX').checked === true){cxd4GFX = 'rsp-cxd4[DisplayListToGraphicsPlugin]=True'}
else{cxd4GFX = 'rsp-cxd4[DisplayListToGraphicsPlugin]=False'}
if(id('rspAudio').checked === true){cxd4Audio = 'rsp-cxd4[AudioListToAudioPlugin]=True'; m64pAudio = 'Rsp-HLE[AudioListToAudioPlugin]=True'}
else{cxd4Audio = 'rsp-cxd4[AudioListToAudioPlugin]=False'; m64pAudio = 'Rsp-HLE[AudioListToAudioPlugin]=False'}
if(id('WaitForCPUHost').checked === true){WaitForCPUHost = 'rsp-cxd4[WaitForCPUHost]=True'}else{WaitForCPUHost = 'rsp-cxd4[WaitForCPUHost]=False'}
if(id('SupportCPUSemaphoreLock').checked === true){SupportCPUSemaphoreLock = 'rsp-cxd4[SupportCPUSemaphoreLock]=True'}else{SupportCPUSemaphoreLock = 'rsp-cxd4[SupportCPUSemaphoreLock]=False'}
if(id('threadedVideo').checked === true){threadedVideo = 'Video-GLideN64[ThreadedVideo]=True'}else{threadedVideo = 'Video-GLideN64[ThreadedVideo]=False'}
if(id('bilinearMode').checked === true){bilinearMode = 'Video-GLideN64[bilinearMode]=True'}else{bilinearMode = 'Video-GLideN64[bilinearMode]=False'}
if(id('fxaa').checked === true){fxaa = 'Video-GLideN64[FXAA]=True'}else{fxaa = 'Video-GLideN64[FXAA]=False'}
if(id('enableHalosRemoval').checked === true){enableHalosRemoval = 'Video-GLideN64[enableHalosRemoval]=True'}else{enableHalosRemoval = 'Video-GLideN64[enableHalosRemoval]=False'}
if(id('txHiresEnable').checked === true){txHiresEnable = 'Video-GLideN64[txHiresEnable]=True'}else{txHiresEnable = 'Video-GLideN64[txHiresEnable]=False'}
if(id('txNoTextureFileStorage').checked === true){txNoTextureFileStorage = 'Video-GLideN64[txNoTextureFileStorage]=True'}else{txNoTextureFileStorage = 'Video-GLideN64[txNoTextureFileStorage]=False'}
if(id('EnableInaccurateTextureCoordinates').checked === true){EnableInaccurateTextureCoordinates = 'Video-GLideN64[EnableInaccurateTextureCoordinates]=True'}else{EnableInaccurateTextureCoordinates = 'Video-GLideN64[EnableInaccurateTextureCoordinates]=False'}
if(id('EnableDitheringPattern').checked === true){EnableDitheringPattern = 'Video-GLideN64[EnableDitheringPattern]=True'}else{EnableDitheringPattern = 'Video-GLideN64[EnableDitheringPattern]=False'}
if(id('EnableHiresNoiseDithering').checked === true){EnableHiresNoiseDithering = 'Video-GLideN64[EnableHiresNoiseDithering]=True'}else{EnableHiresNoiseDithering = 'Video-GLideN64[EnableHiresNoiseDithering]=False'}
if(id('DitheringQuantization').checked === true){DitheringQuantization = 'Video-GLideN64[DitheringQuantization]=True'}else{DitheringQuantization = 'Video-GLideN64[DitheringQuantization]=False'}
if(id('EnableHWLighting').checked === true){EnableHWLighting = 'Video-GLideN64[EnableHWLighting]=True'}else{EnableHWLighting = 'Video-GLideN64[EnableHWLighting]=False'}
if(id('EnableCoverage').checked === true){EnableCoverage = 'Video-GLideN64[EnableCoverage]=True'}else{EnableCoverage = 'Video-GLideN64[EnableCoverage]=False'}
if(id('EnableClipping').checked === true){EnableClipping = 'Video-GLideN64[EnableClipping]=True'}else{EnableClipping = 'Video-GLideN64[EnableClipping]=False'}
if(id('EnableShadersStorage').checked === true){EnableShadersStorage = 'Video-GLideN64[EnableShadersStorage]=True'}else{EnableShadersStorage = 'Video-GLideN64[EnableShadersStorage]=False'}
if(id('EnableLegacyBlending').checked === true){EnableLegacyBlending = 'Video-GLideN64[EnableLegacyBlending]=True'}else{EnableLegacyBlending = 'Video-GLideN64[EnableLegacyBlending]=False'}
if(id('EnableHybridFilter').checked === true){EnableHybridFilter = 'Video-GLideN64[EnableHybridFilter]=True'}else{EnableHybridFilter = 'Video-GLideN64[EnableHybridFilter]=False'}
if(id('EnableFragmentDepthWrite').checked === true){EnableFragmentDepthWrite = 'Video-GLideN64[EnableFragmentDepthWrite]=True'}else{EnableFragmentDepthWrite = 'Video-GLideN64[EnableFragmentDepthWrite]=False'}
if(id('EnableCustomSettings').checked === true){EnableCustomSettings = 'Video-GLideN64[EnableCustomSettings]=True'}else{EnableCustomSettings = 'Video-GLideN64[EnableCustomSettings]=False'}
if(id('EnableTexCoordBounds').checked === true){EnableTexCoordBounds = 'Video-GLideN64[EnableTexCoordBounds]=1'}else{EnableTexCoordBounds = 'Video-GLideN64[EnableTexCoordBounds]=0'}
if(id('EnableLOD').checked === true){EnableLOD = 'Video-GLideN64[EnableLOD]=True'}else{EnableLOD = 'Video-GLideN64[EnableLOD]=False'}
if(id('EnableFBEmulation').checked === true){EnableFBEmulation = 'Video-GLideN64[EnableFBEmulation]=True'}else{EnableFBEmulation = 'Video-GLideN64[EnableFBEmulation]=False'}
if(id('EnableCopyAuxiliaryToRDRAM').checked === true){EnableCopyAuxiliaryToRDRAM = 'Video-GLideN64[EnableCopyAuxiliaryToRDRAM]=True'}else{EnableCopyAuxiliaryToRDRAM = 'Video-GLideN64[EnableCopyAuxiliaryToRDRAM]=False'}
if(id('ForceDepthBufferClear').checked === true){ForceDepthBufferClear = 'Video-GLideN64[ForceDepthBufferClear]=True'}else{ForceDepthBufferClear = 'Video-GLideN64[ForceDepthBufferClear]=False'}
if(id('DisableFBInfo').checked === true){DisableFBInfo = 'Video-GLideN64[DisableFBInfo]=True'}else{DisableFBInfo = 'Video-GLideN64[DisableFBInfo]=False'}
if(id('FBInfoReadColorChunk').checked === true){FBInfoReadColorChunk = 'Video-GLideN64[FBInfoReadColorChunk]=True'}else{FBInfoReadColorChunk = 'Video-GLideN64[FBInfoReadColorChunk]=False'}
if(id('FBInfoReadDepthChunk').checked === true){FBInfoReadDepthChunk = 'Video-GLideN64[FBInfoReadDepthChunk]=True'}else{FBInfoReadDepthChunk = 'Video-GLideN64[FBInfoReadDepthChunk]=False'}
if(id('EnableCopyColorFromRDRAM').checked === true){EnableCopyColorFromRDRAM = 'Video-GLideN64[EnableCopyColorFromRDRAM]=True'}else{EnableCopyColorFromRDRAM = 'Video-GLideN64[EnableCopyColorFromRDRAM]=False'}
if(id('EnableCopyDepthToMainDepthBuffer').checked === true){EnableCopyDepthToMainDepthBuffer = 'Video-GLideN64[EnableCopyDepthToMainDepthBuffer]=True'}else{EnableCopyDepthToMainDepthBuffer = 'Video-GLideN64[EnableCopyDepthToMainDepthBuffer]=False'}
if(id('EnableOverscan').checked === true){EnableOverscan = 'Video-GLideN64[EnableOverscan]=True'}else{EnableOverscan = 'Video-GLideN64[EnableOverscan]=False'}
if(id('txDeposterize').checked === true){txDeposterize = 'Video-GLideN64[txDeposterize]=True'}else{txDeposterize = 'Video-GLideN64[txDeposterize]=False'}
if(id('txFilterIgnoreBG').checked === true){txFilterIgnoreBG = 'Video-GLideN64[txFilterIgnoreBG]=True'}else{txFilterIgnoreBG = 'Video-GLideN64[txFilterIgnoreBG]=False'}
if(id('txHiresFullAlphaChannel').checked === true){txHiresFullAlphaChannel = 'Video-GLideN64[txHiresFullAlphaChannel]=True'}else{txHiresFullAlphaChannel = 'Video-GLideN64[txHiresFullAlphaChannel]=False'}
if(id('txHresAltCRC').checked === true){txHresAltCRC = 'Video-GLideN64[txHresAltCRC]=True'}else{txHresAltCRC = 'Video-GLideN64[txHresAltCRC]=False'}
if(id('txCacheCompression').checked === true){txCacheCompression = 'Video-GLideN64[txCacheCompression]=True'}else{txCacheCompression = 'Video-GLideN64[txCacheCompression]=False'}
if(id('txForce16bpp').checked === true){txForce16bpp = 'Video-GLideN64[txForce16bpp]=True'}else{txForce16bpp = 'Video-GLideN64[txForce16bpp]=False'}
if(id('txSaveCache').checked === true){txSaveCache = 'Video-GLideN64[txSaveCache]=True'}else{txSaveCache = 'Video-GLideN64[txSaveCache]=False'}
if(id('ForceGammaCorrection').checked === true){ForceGammaCorrection = 'Video-GLideN64[ForceGammaCorrection]=True'}else{ForceGammaCorrection = 'Video-GLideN64[ForceGammaCorrection]=False'}
if(id('ShowFPS').checked === true){ShowFPS = 'Video-GLideN64[ShowFPS]=True'}else{ShowFPS = 'Video-GLideN64[ShowFPS]=False'}
if(id('ShowVIS').checked === true){ShowVIS = 'Video-GLideN64[ShowVIS]=True'}else{ShowVIS = 'Video-GLideN64[ShowVIS]=False'}
if(id('ShowPercent').checked === true){ShowPercent = 'Video-GLideN64[ShowPercent]=True'}else{ShowPercent = 'Video-GLideN64[ShowPercent]=False'}
if(id('ShowInternalResolution').checked === true){ShowInternalResolution = 'Video-GLideN64[ShowInternalResolution]=True'}else{ShowInternalResolution = 'Video-GLideN64[ShowInternalResolution]=False'}
if(id('ShowRenderingResolution').checked === true){ShowRenderingResolution = 'Video-GLideN64[ShowRenderingResolution]=True'}else{ShowRenderingResolution = 'Video-GLideN64[ShowRenderingResolution]=False'}
if(id('ShowStatistics').checked === true){ShowStatistics = 'Video-GLideN64[ShowStatistics]=True'}else{ShowStatistics = 'Video-GLideN64[ShowStatistics]=False'}

if(id('NoCompiledJump').checked === true){NoCompiledJump = 'Core[NoCompiledJump]=True'}else{NoCompiledJump = 'Core[NoCompiledJump]=False'}
if(id('AutoStateSlotIncrement').checked === true){AutoStateSlotIncrement = 'Core[AutoStateSlotIncrement]=True'}else{AutoStateSlotIncrement = 'Core[AutoStateSlotIncrement]=False'}
if(id('RandomizeInterrupt').checked === true){RandomizeInterrupt = 'Core[RandomizeInterrupt]=True'}else{RandomizeInterrupt = 'Core[RandomizeInterrupt]=False'}
if(id('SWAP_CHANNELS').checked === true){SWAP_CHANNELS = 'Audio-SDL[SWAP_CHANNELS]=True'}else{SWAP_CHANNELS = 'Audio-SDL[SWAP_CHANNELS]=False'}
if(id('AUDIO_SYNC').checked === true){AUDIO_SYNC = 'Audio-SDL[AUDIO_SYNC]=True'}else{AUDIO_SYNC = 'Audio-SDL[AUDIO_SYNC]=False'}

if(id('Parallel').checked === true){Parallel = 'Video-Angrylion-Plus[Parallel]=True'}else{Parallel = 'Video-Angrylion-Plus[Parallel]=False'}
if(id('BusyLoop').checked === true){BusyLoop = 'Video-Angrylion-Plus[BusyLoop]=True'}else{BusyLoop = 'Video-Angrylion-Plus[BusyLoop]=False'}
if(id('ViWidescreen').checked === true){ViWidescreen = 'Video-Angrylion-Plus[ViWidescreen]=True'}else{ViWidescreen = 'Video-Angrylion-Plus[ViWidescreen]=False'}
if(id('ViHideOverscan').checked === true){ViHideOverscan = 'Video-Angrylion-Plus[ViHideOverscan]=True'}else{ViHideOverscan = 'Video-Angrylion-Plus[ViHideOverscan]=False'}
if(id('ViIntegerScaling').checked === true){ViIntegerScaling = 'Video-Angrylion-Plus[ViIntegerScaling]=True'}else{ViIntegerScaling = 'Video-Angrylion-Plus[ViIntegerScaling]=False'}

if(id('ParallelSuperscaledReads').checked === true){ParallelSuperscaledReads = 'Video-Parallel[SuperscaledReads]=True'}else{ParallelSuperscaledReads = 'Video-Parallel[SuperscaledReads]=False'}
if(id('ParallelSuperscaledDither').checked === true){ParallelSuperscaledDither = 'Video-Parallel[SuperscaledDither]=True'}else{ParallelSuperscaledDither = 'Video-Parallel[SuperscaledDither]=False'}
if(id('ParallelIntegerScale').checked === true){ParallelIntegerScale = 'Video-Parallel[IntegerScale]=True'}else{ParallelIntegerScale = 'Video-Parallel[IntegerScale]=False'}
if(id('ParallelVIAA').checked === true){ParallelVIAA = 'Video-Parallel[VIAA]=True'}else{ParallelVIAA = 'Video-Parallel[VIAA]=False'}
if(id('ParallelDivot').checked === true){ParallelDivot = 'Video-Parallel[Divot]=True'}else{ParallelDivot = 'Video-Parallel[Divot]=False'}
if(id('ParallelGammaDither').checked === true){ParallelGammaDither = 'Video-Parallel[GammaDither]=True'}else{ParallelGammaDither = 'Video-Parallel[GammaDither]=False'}
if(id('ParallelVIBilerp').checked === true){ParallelVIBilerp = 'Video-Parallel[VIBilerp]=True'}else{ParallelVIBilerp = 'Video-Parallel[VIBilerp]=False'}
if(id('ParallelVIDither').checked === true){ParallelVIDither = 'Video-Parallel[VIDither]=True'}else{ParallelVIDither = 'Video-Parallel[VIDither]=False'}
if(id('ParallelNativeTextLOD').checked === true){ParallelNativeTextLOD = 'Video-Parallel[NativeTextLOD]=True'}else{ParallelNativeTextLOD = 'Video-Parallel[NativeTextLOD]=False'}
if(id('ParallelNativeTextRECT').checked === true){ParallelNativeTextRECT = 'Video-Parallel[NativeTextRECT]=True'}else{ParallelNativeTextRECT = 'Video-Parallel[NativeTextRECT]=False'}
if(id('ParallelWidescreenStretch').checked === true){ParallelWidescreenStretch = 'Video-Parallel[WidescreenStretch]=True'}else{ParallelWidescreenStretch = 'Video-Parallel[WidescreenStretch]=False'}

if(id('FrameBufferSetting').checked === true){FrameBufferSetting = 'Video-Rice[FrameBufferSetting]=1'}else{FrameBufferSetting = 'Video-Rice[FrameBufferSetting]=0'}
if(id('NormalAlphaBlender').checked === true){NormalAlphaBlender = 'Video-Rice[NormalAlphaBlender]=True'}else{NormalAlphaBlender = 'Video-Rice[NormalAlphaBlender]=False'}
if(id('FastTextureLoading').checked === true){FastTextureLoading = 'Video-Rice[FastTextureLoading]=True'}else{FastTextureLoading = 'Video-Rice[FastTextureLoading]=False'}
if(id('AccurateTextureMapping').checked === true){AccurateTextureMapping = 'Video-Rice[AccurateTextureMapping]=True'}else{AccurateTextureMapping = 'Video-Rice[AccurateTextureMapping]=False'}
if(id('InN64Resolution').checked === true){InN64Resolution = 'Video-Rice[InN64Resolution]=True'}else{InN64Resolution = 'Video-Rice[InN64Resolution]=False'}
if(id('SaveVRAM').checked === true){SaveVRAM = 'Video-Rice[SaveVRAM]=True'}else{SaveVRAM = 'Video-Rice[SaveVRAM]=False'}
if(id('DoubleSizeForSmallTxtrBuf').checked === true){DoubleSizeForSmallTxtrBuf = 'Video-Rice[DoubleSizeForSmallTxtrBuf]=True'}else{DoubleSizeForSmallTxtrBuf = 'Video-Rice[DoubleSizeForSmallTxtrBuf]=False'}
if(id('DefaultCombinerDisable').checked === true){DefaultCombinerDisable = 'Video-Rice[DefaultCombinerDisable]=True'}else{DefaultCombinerDisable = 'Video-Rice[DefaultCombinerDisable]=False'}
if(id('EnableHacks').checked === true){EnableHacks = 'Video-Rice[EnableHacks]=True'}else{EnableHacks = 'Video-Rice[EnableHacks]=False'}
if(id('WinFrameMode').checked === true){WinFrameMode = 'Video-Rice[WinFrameMode]=True'}else{WinFrameMode = 'Video-Rice[WinFrameMode]=False'}
if(id('FullTMEMEmulation').checked === true){FullTMEMEmulation = 'Video-Rice[FullTMEMEmulation]=True'}else{FullTMEMEmulation = 'Video-Rice[FullTMEMEmulation]=False'}
if(id('OpenGLVertexClipper').checked === true){OpenGLVertexClipper = 'Video-Rice[OpenGLVertexClipper]=True'}else{OpenGLVertexClipper = 'Video-Rice[OpenGLVertexClipper]=False'}
if(id('EnableSSE').checked === true){EnableSSE = 'Video-Rice[EnableSSE]=True'}else{EnableSSE = 'Video-Rice[EnableSSE]=False'}
if(id('SkipFrame').checked === true){SkipFrame = 'Video-Rice[SkipFrame]=True'}else{SkipFrame = 'Video-Rice[SkipFrame]=False'}
if(id('TexRectOnly').checked === true){TexRectOnly = 'Video-Rice[TexRectOnly]=True'}else{TexRectOnly = 'Video-Rice[TexRectOnly]=False'}
if(id('SmallTextureOnly').checked === true){SmallTextureOnly = 'Video-Rice[SmallTextureOnly]=True'}else{SmallTextureOnly = 'Video-Rice[SmallTextureOnly]=False'}
if(id('LoadHiResCRCOnly').checked === true){LoadHiResCRCOnly = 'Video-Rice[LoadHiResCRCOnly]=True'}else{LoadHiResCRCOnly = 'Video-Rice[LoadHiResCRCOnly]=False'}
if(id('LoadHiResTextures').checked === true){LoadHiResTextures = 'Video-Rice[LoadHiResTextures]=True'}else{LoadHiResTextures = 'Video-Rice[LoadHiResTextures]=False'}
if(id('DumpTexturesToFiles').checked === true){DumpTexturesToFiles = 'Video-Rice[DumpTexturesToFiles]=True'}else{DumpTexturesToFiles = 'Video-Rice[DumpTexturesToFiles]=False'}
if(id('RiceShowFPS').checked === true){RiceShowFPS = 'Video-Rice[ShowFPS]=True'}else{RiceShowFPS = 'Video-Rice[ShowFPS]=False'}
if(id('FogMethod').checked === true){FogMethod = 'Video-Rice[FogMethod]=1'}else{FogMethod = 'Video-Rice[FogMethod]=0'}
if(id('OpenGLRenderSetting').checked === true){OpenGLRenderSetting = 'Video-Rice[OpenGLRenderSetting]=1'}else{OpenGLRenderSetting = 'Video-Rice[OpenGLRenderSetting]=0'}
if(id('ForcePolygonOffset').checked === true){ForcePolygonOffset = 'Video-Rice[ForcePolygonOffset]=True'}else{ForcePolygonOffset = 'Video-Rice[ForcePolygonOffset]=False'}

if(id('force_polygon_offset').checked === true){force_polygon_offset = 'Video-Glide64mk2[force_polygon_offset]=True'}else{force_polygon_offset = 'Video-Glide64mk2[force_polygon_offset]=False'}
if(id('clock').checked === true){clock = 'Video-Glide64mk2[clock]=True'}else{clock = 'Video-Glide64mk2[clock]=False'}
if(id('clock_24_hr').checked === true){clock_24_hr = 'Video-Glide64mk2[clock_24_hr]=True'}else{clock_24_hr = 'Video-Glide64mk2[clock_24_hr]=False'}
if(id('wrpFBO').checked === true){wrpFBO = 'Video-Glide64mk2[wrpFBO]=True'}else{wrpFBO = 'Video-Glide64mk2[wrpFBO]=False'}
if(id('wrpAnisotropic').checked === true){wrpAnisotropic = 'Video-Glide64mk2[wrpAnisotropic]=True'}else{wrpAnisotropic = 'Video-Glide64mk2[wrpAnisotropic]=False'}
if(id('ghq_hirs').checked === true){ghq_hirs = 'Video-Glide64mk2[ghq_hirs]=1'}else{ghq_hirs = 'Video-Glide64mk2[ghq_hirs]=0'}
if(id('ghq_enht_cmpr').checked === true){ghq_enht_cmpr = 'Video-Glide64mk2[ghq_enht_cmpr]=True'}else{ghq_enht_cmpr = 'Video-Glide64mk2[ghq_enht_cmpr]=False'}
if(id('ghq_enht_tile').checked === true){ghq_enht_tile = 'Video-Glide64mk2[ghq_enht_tile]=1'}else{ghq_enht_tile = 'Video-Glide64mk2[ghq_enht_tile]=0'}
if(id('ghq_enht_f16bpp').checked === true){ghq_enht_f16bpp = 'Video-Glide64mk2[ghq_enht_f16bpp]=True'}else{ghq_enht_f16bpp = 'Video-Glide64mk2[ghq_enht_f16bpp]=False'}
if(id('ghq_enht_gz').checked === true){ghq_enht_gz = 'Video-Glide64mk2[ghq_enht_gz]=True'}else{ghq_enht_gz = 'Video-Glide64mk2[ghq_enht_gz]=False'}
if(id('ghq_enht_nobg').checked === true){ghq_enht_nobg = 'Video-Glide64mk2[ghq_enht_nobg]=True'}else{ghq_enht_nobg = 'Video-Glide64mk2[ghq_enht_nobg]=False'}
if(id('ghq_hirs_cmpr').checked === true){ghq_hirs_cmpr = 'Video-Glide64mk2[ghq_hirs_cmpr]=True'}else{ghq_hirs_cmpr = 'Video-Glide64mk2[ghq_hirs_cmpr]=False'}
if(id('ghq_hirs_tile').checked === true){ghq_hirs_tile = 'Video-Glide64mk2[ghq_hirs_tile]=True'}else{ghq_hirs_tile = 'Video-Glide64mk2[ghq_hirs_tile]=False'}
if(id('ghq_hirs_f16bpp').checked === true){ghq_hirs_f16bpp = 'Video-Glide64mk2[ghq_hirs_f16bpp]=True'}else{ghq_hirs_f16bpp = 'Video-Glide64mk2[ghq_hirs_f16bpp]=False'}
if(id('ghq_hirs_gz').checked === true){ghq_hirs_gz = 'Video-Glide64mk2[ghq_hirs_gz]=True'}else{ghq_hirs_gz = 'Video-Glide64mk2[ghq_hirs_gz]=False'}
if(id('ghq_hirs_altcrc').checked === true){ghq_hirs_altcrc = 'Video-Glide64mk2[ghq_hirs_altcrc]=True'}else{ghq_hirs_altcrc = 'Video-Glide64mk2[ghq_hirs_altcrc]=False'}
if(id('ghq_cache_save').checked === true){ghq_cache_save = 'Video-Glide64mk2[ghq_cache_save]=True'}else{ghq_cache_save = 'Video-Glide64mk2[ghq_cache_save]=False'}
if(id('ghq_hirs_let_texartists_fly').checked === true){ghq_hirs_let_texartists_fly = 'Video-Glide64mk2[ghq_hirs_let_texartists_fly]=True'}else{ghq_hirs_let_texartists_fly = 'Video-Glide64mk2[ghq_hirs_let_texartists_fly]=False'}
if(id('ghq_hirs_dump').checked === true){ghq_hirs_dump = 'Video-Glide64mk2[ghq_hirs_dump]=True'}else{ghq_hirs_dump = 'Video-Glide64mk2[ghq_hirs_dump]=False'}

if(id('plugged1').checked === true){plugged1 = 'Input-SDL-Control1[plugged]=True'}else{plugged1 = 'Input-SDL-Control1[plugged]=False'}
if(id('plugged2').checked === true){plugged2 = 'Input-SDL-Control2[plugged]=True'}else{plugged2 = 'Input-SDL-Control2[plugged]=False'}
if(id('plugged3').checked === true){plugged3 = 'Input-SDL-Control3[plugged]=True'}else{plugged3 = 'Input-SDL-Control3[plugged]=False'}
if(id('plugged4').checked === true){plugged4 = 'Input-SDL-Control4[plugged]=True'}else{plugged4 = 'Input-SDL-Control4[plugged]=False'}
if(id('mouse1').checked === true){mouse1 = 'Input-SDL-Control1[mouse]=True'}else{mouse1 = 'Input-SDL-Control1[mouse]=False'}
if(id('mouse2').checked === true){mouse2 = 'Input-SDL-Control2[mouse]=True'}else{mouse2 = 'Input-SDL-Control2[mouse]=False'}
if(id('mouse3').checked === true){mouse3 = 'Input-SDL-Control3[mouse]=True'}else{mouse3 = 'Input-SDL-Control3[mouse]=False'}
if(id('mouse4').checked === true){mouse4 = 'Input-SDL-Control4[mouse]=True'}else{mouse4 = 'Input-SDL-Control4[mouse]=False'}
...
if(id('mouse1').checked === true && id('mouse1_1').options[id('mouse1_1').selectedIndex].value != ''){
...
if(id('mouse1').checked === true && id('mouse1_2').options[id('mouse1_2').selectedIndex].value != ''){
...
if(id('mouse1').checked === true && id('mouse1_3').options[id('mouse1_3').selectedIndex].value != ''){
...
if(id('mouse2').checked === true && id('mouse2_1').options[id('mouse2_1').selectedIndex].value != ''){
...
if(id('mouse2').checked === true && id('mouse2_2').options[id('mouse2_2').selectedIndex].value != ''){
...
if(id('mouse2').checked === true && id('mouse2_3').options[id('mouse2_3').selectedIndex].value != ''){
...
if(id('mouse3').checked === true && id('mouse3_1').options[id('mouse3_1').selectedIndex].value != ''){
...
if(id('mouse3').checked === true && id('mouse3_2').options[id('mouse3_2').selectedIndex].value != ''){
...
if(id('mouse3').checked === true && id('mouse3_3').options[id('mouse3_3').selectedIndex].value != ''){
...
if(id('mouse4').checked === true && id('mouse4_1').options[id('mouse4_1').selectedIndex].value != ''){
...
if(id('mouse4').checked === true && id('mouse4_2').options[id('mouse4_2').selectedIndex].value != ''){
...
if(id('mouse4').checked === true && id('mouse4_3').options[id('mouse4_3').selectedIndex].value != ''){
...
if(id('nospeedlimit').checked === true){nospeedlimit = ['--nospeedlimit'];audio = 'dummy';vsync = 'Video-General[VerticalSync]=False';Glide64VSync = 'Video-Glide64mk2[vsync]=False'}else{nospeedlimit = []}
if(id('verbose').checked === true){verbose = '--verbose'}else{verbose = []}
...
if(id('mode1').value != 'Input-SDL-Control1[mode]=0'){controls1 = []}
if(id('mode2').value != 'Input-SDL-Control2[mode]=0'){controls2 = []}
if(id('mode3').value != 'Input-SDL-Control3[mode]=0'){controls3 = []}
if(id('mode4').value != 'Input-SDL-Control4[mode]=0'){controls4 = []}
...
const parameters = controls1.concat(controls2,controls3,controls4,nospeedlimit,verbose,cheats,config),
