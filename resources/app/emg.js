...
EnableInaccurateTextureCoordinatesCheckbox = document.getElementById('EnableInaccurateTextureCoordinates'),
...
hkInaccurateTexCordsBox = document.getElementById('hkInaccurateTexCords'),
...
txHiresVramLimitInput = document.getElementById('txHiresVramLimit'),
...
CountPerOpDenomPotInput = document.getElementById('CountPerOpDenomPot'),
...
decreaseCountPerOpDenomPot = document.getElementById('decreaseCountPerOpDenomPot'),
increaseCountPerOpDenomPot = document.getElementById('increaseCountPerOpDenomPot'),
...
decreasetxHiresVramLimit = document.getElementById('decreasetxHiresVramLimit'),
increasetxHiresVramLimit = document.getElementById('increasetxHiresVramLimit'),
...
document.getElementById('clearhkInaccurateTexCords').addEventListener('click', function(){
hkInaccurateTexCordsBox.value = '';
localStorage.removeItem('hkInaccurateTexCords')})
if(localStorage.getItem('hkInaccurateTexCords') != null){
hkInaccurateTexCordsBox.value = hotKeys[localStorage.getItem('hkInaccurateTexCords')]}
hkInaccurateTexCordsBox.addEventListener('keyup', function(e){
if(hotKeys[e.keyCode] != undefined){
hkInaccurateTexCordsBox.value = hotKeys[e.keyCode];
localStorage.setItem('hkInaccurateTexCords', e.keyCode)}})
...
if(localStorage.getItem('txHiresVramLimit') != null){txHiresVramLimitInput.value = localStorage.getItem('txHiresVramLimit')}
txHiresVramLimitInput.addEventListener('change', function(){localStorage.setItem('txHiresVramLimit', txHiresVramLimitInput.value)})
txHiresVramLimitInput.addEventListener('keydown', function(e){e.preventDefault()})
...
if(localStorage.getItem('CountPerOpDenomPot') != null){CountPerOpDenomPotInput.value = localStorage.getItem('CountPerOpDenomPot')}
CountPerOpDenomPotInput.addEventListener('change', function(){localStorage.setItem('CountPerOpDenomPot', CountPerOpDenomPotInput.value)})
CountPerOpDenomPotInput.addEventListener('keydown', function(e){e.preventDefault()})
...
decreaseCountPerOpDenomPot.addEventListener('click', function(){if(CountPerOpDenomPotInput.value != CountPerOpDenomPotInput.min){CountPerOpDenomPotInput.value = parseInt(CountPerOpDenomPotInput.value) - 1;localStorage.setItem('CountPerOpDenomPot', CountPerOpDenomPotInput.value)}})
increaseCountPerOpDenomPot.addEventListener('click', function(){if(CountPerOpDenomPotInput.value != CountPerOpDenomPotInput.max){CountPerOpDenomPotInput.value = parseInt(CountPerOpDenomPotInput.value) + 1;localStorage.setItem('CountPerOpDenomPot', CountPerOpDenomPotInput.value)}})
...
decreasetxHiresVramLimit.addEventListener('click', function(){if(txHiresVramLimitInput.value != txHiresVramLimitInput.min){txHiresVramLimitInput.value = parseInt(txHiresVramLimitInput.value) - 512;localStorage.setItem('txHiresVramLimit', txHiresVramLimitInput.value)}})
increasetxHiresVramLimit.addEventListener('click', function(){if(txHiresVramLimitInput.value != txHiresVramLimitInput.max){txHiresVramLimitInput.value = parseInt(txHiresVramLimitInput.value) + 512;localStorage.setItem('txHiresVramLimit', txHiresVramLimitInput.value)}})
...
if(EnableInaccurateTextureCoordinatesCheckbox.checked === true){EnableInaccurateTextureCoordinates = 'Video-GLideN64[EnableInaccurateTextureCoordinates]=True'}else{EnableInaccurateTextureCoordinates = 'Video-GLideN64[EnableInaccurateTextureCoordinates]=False'}
...
txHiresVramLimit = 'Video-GLideN64[txHiresVramLimit]=' + txHiresVramLimitInput.value;
...
CountPerOpDenomPot = 'Core[CountPerOpDenomPot]=' + CountPerOpDenomPotInput.value;
...
hkInaccurateTexCords = 'Video-GLideN64[hkInaccurateTexCords]=' + hkInaccurateTexCordsBox.value;
...
if(document.getElementById('verbose').checked === true){verbose = '--verbose'}else{verbose = []}
